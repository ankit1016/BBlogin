...
Thanks to contributors: **@erkan-ozkan**, **@HO-COOH**, **@sleiner**, **@Philanatidae**

## Screenshots
Automatically insert include guard when creating a new header file

![Automatic Insert](https://github.com/AkiraMiyakoda/cppIncludeGuard/raw/HEAD/images/auto-insert.gif)
...
![Automatic updating](https://github.com/AkiraMiyakoda/cppIncludeGuard/raw/HEAD/images/auto-update.gif)
